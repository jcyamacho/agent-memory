...
const SERVER_INSTRUCTIONS = [
  ...
  "(2) During the session, call `remember` to save a new fact, `revise` to correct content or promote a project-scoped memory to global scope, and `forget` to remove one that is wrong or obsolete.",
